...
marker0.bindPopup("I am a marker.");
marker1.bindPopup("I am a marker.");
marker2.bindPopup("I am a marker.");
marker3.bindPopup("I am a marker.");
...
L.marker([41.727961, -71.460528], {icon: greenIcon}).addTo(mymap);
...
L.marker([41.728056, -71.475549], {icon: greenIcon}).addTo(mymap).bindPopup("I am a green leaf.");
